  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        CustomedTextFormField(hintText: 'search_for_event'.tr(),suffixIcon: Icon(Icons.search),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Icon(Icons.favorite_outlined,color:themeProvider.themeMode==ThemeMode.light?EventlyColors.main_blue:EventlyColors.main_dark_blue,size: 30,)
                    ],
                  ),
                ),
              )
