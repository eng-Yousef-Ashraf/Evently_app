    ...
    return ListView.separated(itemBuilder: (context, index) {
      return Container(
        ...
        decoration: BoxDecoration(
            ...
            image: DecorationImage(image:themeProvider.themeMode==ThemeMode.light? AssetImage(EventlyAssets.meeting): AssetImage(EventlyAssets.dark_meeting),
                fit: BoxFit.fill)
        ),
        child: Column(
