    ...
    return ListView.separated(itemBuilder: (context, index) {
      return Container(
        ...
        decoration: BoxDecoration(
            ...
            image: DecorationImage(image:themeProvider.themeMode==ThemeMode.light? AssetImage(EventlyAssets.exhibition): AssetImage(EventlyAssets.dark_exhibition),
                fit: BoxFit.fill)
        ),
        child: Column(
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Text('exhibition_event'.tr(),
                        maxLines: 4,
                        style: Theme.of(context).textTheme.displayLarge,),
                    ),
